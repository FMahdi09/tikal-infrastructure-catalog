...
output "debug_csr_lookup" {
  value     = local.csr_lookup
  sensitive = true
}
output "debug_pending_csr" {
  value     = local.pending_csr
  sensitive = true
}
output "debug_stored_csr" {
  value     = local.stored_csr
  sensitive = true
}
output "debug_get_csr" {
  value     = data.external.get_csr
  sensitive = true
}
output "debug_script_path" {
  value = "${path.module}/Scripts/certmgmt.sh"
}
